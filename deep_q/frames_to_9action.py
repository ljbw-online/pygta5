...
from common import reinforcement_resumed_bytes, w_bytes, s_bytes, wa_bytes, wd_bytes, state_bytes, \
    reinforcement_paused_bytes, get_frame, sa_bytes, sd_bytes, a_bytes, d_bytes, nk_bytes, uint8_to_float32
...
num_actions = 9  # Used in training script
...
def visualise(q):
    ...
    #                   w          wa         wd         s           sa          sd          a           d           nk
    square_top_lefts = [(410, 20), (300, 20), (520, 20), (410, 240), (300, 240), (520, 240), (300, 130), (520, 130), (410, 130)]
    # tl_grid =[(300, 20), (410, 20), (520, 20), (300, 130), (410, 130), (520, 130), (300, 240), (410, 240), (520, 240)]
    #                       w           wa          wd          s           sa          sd          a           d     nk
    square_bottom_rights = [(510, 120), (400, 120), (620, 120), (510, 340), (400, 340), (620, 340), (400, 230), (620, 230), (510, 230)]
    # br_grid=[(400, 120), (510, 120), (620, 120), (400, 230), (510, 230), (620, 230), (400, 340),(510, 340),(620, 340)]
    letter_bottom_lefts = [(440, 70), (330, 70), (550, 70), (440, 290), (330, 290), (550, 290), (330, 180), (550, 180), (440, 180)]
    number_bottom_lefts = [(430, 100), (320, 100), (540, 100), (430, 330), (320, 330), (540, 330), (320, 210), (540, 210), (430, 210)]
    # old_letter_bls = [(330, 90), (440, 90), (550, 90), (330, 200), (440, 200),(550,200),(330,310),(440,310),(550,310)]
    letters = ['W', 'WA', 'WD', 'S', 'SA', 'SD', 'A', 'D', 'NK']
...
class Env:
    def __init__(self, mode, history_len=10):
        # self.frame_deque = deque(maxlen=stack_len)
    ...
    def send_action(self, action):
        ...
        match action:
            ...
            case 4:
                self.sock.sendall(sa_bytes)
            case 5:
                self.sock.sendall(sd_bytes)
            case 6:
                self.sock.sendall(a_bytes)
            case 7:
                self.sock.sendall(d_bytes)
            case 8:
    ...
    def step(self, action, keys):
        ...
        #     reward = max(0, forward_speed)
            ...
            reward = max(0, forward_speed) / 100
