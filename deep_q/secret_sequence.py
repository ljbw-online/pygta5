...
class Env(PyEnvironment):
    def __init__(self, discount=0.99, eval_mode=False, num_actions=2, depth=7):
        ...
        self.secret_sequence = [1, 0, 0, 1, 0, 1, 1, 0]

        # rng = np.random.default_rng(depth)
        # self.secret_sequence = rng.integers(num_actions, size=depth + 1)
    ...
    def _step(self, action):
        ...
        if self.step_count == self.episode_length:
            ...
            if not self.correct_zeroth_action:
